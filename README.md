...
[![Version](https://img.shields.io/badge/version-v-blue.svg)](https://github.com/xdfnet/iDict/releases)
...
1. 应用启动后自动开启媒体服务器
2. 手机浏览器打开电脑 IP 的 8888 端口（如 `http://127.0.0.1:8888`）
